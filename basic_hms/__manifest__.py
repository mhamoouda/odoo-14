...
""",
    ...
    "data": [
        ...
        'wizards/medical_appointments_invoice_wizard.xml',
        'wizards/create_prescription_invoice_wizard.xml',
        'wizards/create_prescription_shipment_wizard.xml',
        'views/medical_medicament.xml',
        'views/medical_drug_route.xml',
        'wizards/medical_lab_test_create_wizard.xml',
        'wizards/medical_lab_test_invoice_wizard.xml',
